...
const ServicePage: React.FC = () => {
  ...
  useEffect(() => {
    dispatch(fetchPublicFormInfo('1007'));
  }, [dispatch]);
    ...
    return (
      <div className="pagination-container">
        <div className="pagination-info">
          Hiển thị {((currentPage - 1) * pageSize) + 1} - {Math.min(currentPage * pageSize, totalRows)} của {totalRows} dịch vụ
        </div>
  ...
  const handleServiceClick = (service: any) => {
    history.push('/service-detail', { serviceData: service });
  };
          ...
          <div className="service-item-main">
            ...
            <div className="service-item-info">
              <div className="service-item-title">
                {visibleFields.find((f: any) => f.mapfield === "TenDV")?.value || "Không rõ tên"}
              </div>
              <div className="service-item-details">
                {visibleFields.map((field: any, fieldIndex: number) => {
                  // Bỏ qua avatar vì đã hiển thị ở trên
                  if (field.mapfield === "avatar" || field.mapfield === "TenDV") return null;
  ...
  return (
    <IonPage>
      <IonHeader className='ion-home-header_service'>
        <IonToolbar className="tool-bar-header custom-toolbar">
          <div className="toolbar-flex">
            ...
            <div className="toolbar-center">Danh sách dịch vụ</div>
            <div className="toolbar-side" />
          </div>
