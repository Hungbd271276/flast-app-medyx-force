...
const ServiceDetailPage: React.FC = () => {
  ...
  const location = useLocation<{ serviceData?: any }>();
  ...
  useEffect(() => {
    if (serviceData && serviceData.patientData) {
      const serviceDefaultValues: Record<string, string> = {};
      
      serviceData.patientData.forEach((field: any) => {
            ...
            <div className="toolbar-flex">
              <div className="toolbar-side">
                <IonButtons slot="start">
                  <IonBackButton defaultHref="/service" />
                </IonButtons>
              </div>
              <div className="toolbar-center">Chi tiết dịch vụ</div>
              <div className="toolbar-side" />
            </div>
          </IonToolbar>
        </IonHeader>
  ...
  return (
    <IonPage>
      <IonHeader className='ion-home-header_service_detail'>
        <IonToolbar className="tool-bar-header custom-toolbar">
          <div className="toolbar-flex">
            <div className="toolbar-side">
              <IonButtons slot="start">
